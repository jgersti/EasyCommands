...
namespace EasyCommands.Tests.ParameterParsingTests {
    ...
    public class ListParameterProcessorTests : ForceLocale {
        ...
        public void AssignVariableToBasicStaticList() {
            ...
            List<IVariable> listItems = CastList(list).GetValues().ToList();
        ...
        public void AssignVariableIndexToVariable() {
            ...
            List<IVariable> listIndexes = CastList(assignmentCommand.list.index.GetValue()).GetValues().ToList();
        ...
        public void AssignVariableToListSubRange() {
            ...
            VariableAssignmentCommand assignmentCommand = (VariableAssignmentCommand)command;
            Assert.AreEqual("myValue", assignmentCommand.variableName);
            List<IVariable> values = CastList(assignmentCommand.variable.GetValue()).GetValues().ToList();
        ...
        public void AssignListAtIndexValuesToAnotherList() {
            ...
            List<IVariable> assignedValue = CastList(assignmentCommand.value.GetValue()).GetValues().ToList();
        ...
        public void AssignVariableToMultiDimensionalArray() {
            ...
            List<IVariable> myList0 = CastList(values[0].GetValue()).GetValues().ToList();
            ...
            List<IVariable> myList1 = CastList(values[1].GetValue()).GetValues().ToList();
        ...
        public void AssignVariableToMultiDimensionalArraySubList() {
            ...
            VariableAssignmentCommand assignmentCommand = (VariableAssignmentCommand)command;
            Assert.AreEqual("myValue", assignmentCommand.variableName);
            List<IVariable> listValues = CastList(assignmentCommand.variable.GetValue()).GetValues().ToList();
