...
namespace IngameScript {
    partial class Program {
        ...
        public static class ProcessingRules {
            ...
            /// <returns></returns>
            public static List<List<ICommandParameter>> ProcessParameters(List<ICommandParameter> commandParameters) {
            ...
            public static T ParseParameters<T>(List<ICommandParameter> parameters) where T : class, ICommandParameter {
            ...
            static void AddProcessors(List<IParameterProcessor> sortedProcessors, List<ICommandParameter> types) {
