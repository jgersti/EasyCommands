    ...
    partial class Program {
        ...
        public class ListAggregateConditionVariable : IVariable {
            ...
            public Primitive GetValue() {
                ...
                return ResolvePrimitive(Evaluate(list.Count, list.GetValues().Count(v => comparator(v.GetValue(), comparisonValue.GetValue())), aggregationMode));
            }
        }
        ...
        public class ListIndexVariable : IVariable {
            ...
            public void SetValue(IVariable value) {
                ...
                if (indexes.Count == 0) indexes.AddRange(Range(0, list.Count).Select(i => ResolvePrimitive(i)));
        ...
        public class KeyedVariable : IVariable, IComparable<KeyedVariable>, IEquatable<KeyedVariable> {
            ...
            public bool Equals(KeyedVariable variable) => GetKey() == variable.GetKey() && Value.GetValue().value.Equals(variable.Value.GetValue().value);
