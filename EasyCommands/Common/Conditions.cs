...
namespace IngameScript {
    partial class Program {
        ...
        public static BlockCondition AndCondition(BlockCondition a, BlockCondition b) => new BlockCondition((block, blockType) => a(block, blockType) && b(block, blockType));
        public static BlockCondition OrCondition(BlockCondition a, BlockCondition b) => new BlockCondition((block, blockType) => a(block, blockType) || b(block, blockType));
